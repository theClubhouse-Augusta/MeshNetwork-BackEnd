    ...
    */
    ...
    public function updateUser(Request $request) {
        ...
        if (!empty($_FILES['avatar'])) {
            ...
            // check if file is IMAGETYPE_XXX
            ...
            // check if file is a valid IMAGETYPE
         ...
         * 
         * This if block is not redundant
         * App\Userskills will not update 
         * correctly unless it has its own block
        */
        if ( !empty($skills) ) {
    ...
    public function searchName(Request $request) {
        ...
        if ( empty($spaceID) ) {
            ...
            if ( count($users) != 0 ) {
                ...
                return Response::json([ 'error' => 'user: '.$name.' not in member database.' ]);
            }
